...
Analyze construction schedule critical path. Identify critical activities, calculate float, simulate schedule impacts, and optimize project duration.

When the user asks to analyze data and generate insights:
